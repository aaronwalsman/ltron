...
def remap_variants(original_scene, variant_tables):
    ...
    for instance in scene.instances:
        ...
        remapped_scene.add_instance(
            remapped_brick_type, instance.color, instance.pose)
    
    return remapped_scene

def remap_variant_paths(paths, out_path, variant_tables=None):
    ...
    for path in paths:
        ...
        remapped_scene = remap_variants(original_scene)
