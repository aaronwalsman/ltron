...
obs, reward, term, info = env.step({'pick' : None, 'rotation' : [0, 112, 106, 80]})
imshow(obs['render'])
plt.show()
print(reward)
...
print(pos_map[1,1])
print(pos_map[151, 149])
print(neg_map[112, 106])
obs, reward, term, info = env.step({'pick' : [0, 112, 106, 151, 149], 'rotation' : None})
